        ...
        <div class="widget-content nopadding">
          <form name="form2" action="" method="post" class="form-horizontal"> 
            <div class="control-group">
              ...
              <div class="controls">
                                            <select name="iname" id="itemname"  onchange="select_item(this.value);select_unit(this.value)">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text"  class="span11" placeholder="1000.00" name="eprice" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Total Value</label>
              <div class="controls">
                <input type="text"  class="span11" placeholder="1000.00" name="value" />
              </div>
            </div>
